...
MASTER_CSV       = os.path.join(OUTPUT_DIR, 'market_history_master.csv')
...
def main():
    ...
    # Merge into master
    merged = merge_with_master(df)
    print(f"→ Master file now has {len(merged)} total rows at {MASTER_CSV}")
